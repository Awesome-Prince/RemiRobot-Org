...
from RemiRobot.modules.helper_funcs.handlers import (CMD_STARTERS)
from RemiRobot.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from RemiRobot.modules.helper_funcs.chat_status import (
        connection_status, is_user_admin, user_admin)
    from RemiRobot.modules.sql import disable_sql as sql
